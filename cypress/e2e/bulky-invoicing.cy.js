describe('Bulky Test', () => {
  ...
  it('Login to Admin, Navigate to Monitoring Wholesale Orders, and Process Order', () => {
    ...
    // Input Shipping Cost setelah order diproses
    cy.get('input[placeholder="Enter Shipping cost"]')
    .should('be.visible')
    .clear() // Menghapus nilai yang ada
    .type('150') // Memasukkan nilai baru
    .should('have.value', '150');
    
    // Input Other Cost setelah order diproses
    cy.get('input[placeholder="Enter Other cost"]')
    .should('be.visible')
    .clear() // Menghapus nilai yang ada
    .type('75') // Memasukkan nilai baru
  ...
  // // Scenario negative case upload PoS
  // it('Upload File dengan format yang salah - Negative Case', () => {
  ...
  //   // Upload file dengan format yang salah (PDF, TXT, dll)
  //   cy.fixture('test.pdf').then(fileContent => {
  //     cy.log('Upload file dengan format yang salah');
  //     cy.get('.upload-area input[type="file"]').invoke('show').attachFile({
  //       filePath: 'test.pdf', 
  ...
  //   // Verifikasi munculnya pesan error terkait format file
  //   cy.get('.upload-area.is-error .text-danger.text-bold', { timeout: 10000 })
  //     .should('be.visible')
  //     .and('contain.text', 'Jenis File harus jpg, jpeg atau png');
  // });
  ...
  //   cy.fixture('testing1.png').then((fileContent) => {
  //     cy.get('.upload-area input[type="file"]')
  //         .invoke('show')
  //         .attachFile({
  //             fileContent,
  ...
  //   cy.get('.upload-area.is-error .text-danger.text-bold', { timeout: 10000 })
  //    .should('be.visible')
  //    .and('contain.text', 'size is too large (max 2MB)');
  // });


  // Scenario negative case upload PoD
  // it('Upload File dengan format yang salah - Negative Case', () => {
  //   // Step 1: Kunjungi Halaman
  //   cy.visit('/');
  ...
  // Scenario negative case upload PoD dengan ukuran lebih besar dari 2MB
  // it('Upload File dengan Ukuran Melebihi Maksimum', () => {
  //   // Step 1: Kunjungi Halaman
  //   cy.visit('/');
